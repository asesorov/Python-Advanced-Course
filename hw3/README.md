...
Код: [здесь](task_1/matrix_operations.py)

Артефакты: [здесь](artifacts/3.1/)
...
Код: [здесь](task_2/matrix_arithmetic.py)

Артефакты: [здесь](artifacts/3.2/)
...
Код: [здесь](task_3/matrix_hash.py)

Артефакты: [здесь](artifacts/3.3/)
